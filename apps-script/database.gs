...
const SHEET_SCHEMAS = {
  ...
  BULLETINS: ['bulletin_id','planner_id','week_id','date','status','unit_name','stake_name','theme','meeting_type','is_canceled','cancel_reason','presiding','conducting','music_director','organist','opening_hymn','opening_hymn_number','opening_prayer','sacrament_hymn','sacrament_hymn_number','speakers','special_music','closing_hymn','closing_hymn_number','closing_prayer','announcements','include_class_lessons','class_lessons','come_follow_me','cfm_url','cfm_reading','cfm_theme','cfm_introduction','cfm_ideas_for_learning','cfm_reflection','cfm_discussion_question','cfm_family_challenge','cfm_study_tip','cleaning_group','cleaning_date','cleaning_time','cleaning_instructions','show_cleaning','activities','activities_list','next_activities_list','birthdays','birthday_message','birthday_celebrants_list','missionaries','scripture_of_the_week','missionary_challenge','temple_trip_date','familysearch_tip','ancestor_challenge','self_reliance_classes','ward_focus','welfare_reminders','bishopric_message','upcoming_events','qr_whatsapp','qr_familysearch','qr_gospel_library','qr_website','qr_planner_link','custom_links','show_sacrament','show_activities','show_birthdays','show_missionary','show_temple','show_self_reliance','show_focus','show_welfare','show_bishopric','show_upcoming','show_qr','color_theme','pdf_layout','created_date','updated_date'],
...
function dbUpdate(sheetName, pkField, pkValue, updates) {
  const sheet = getOrInitSheet(sheetName);
  ensureSheetColumns(sheet, sheetName, Object.keys(updates));
